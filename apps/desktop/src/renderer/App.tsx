...
function BrandWordmark() {
  return <div className="wordmark">
    <img src={fieloraMark} alt="" aria-hidden="true" />
    <span>Fielora</span>
  </div>;
}
...
export function App() {
  ...
  if (screen === 'startup') {
    ...
    return <main className="startup" data-testid="startup-screen">
      <img className="brand-logo" src={fieloraLogo} alt="Fielora" />
  ...
  if (screen === 'field' && selected) {
    return <div className="shell" data-testid="field-screen">
      <aside><BrandWordmark /><button className="nav active">Fields</button></aside>
  ...
  return <div className="shell" data-testid="now-screen">
    <aside><BrandWordmark /><button className="nav active">Now</button><button className="nav">Fields</button></aside>
    <main className="content">
